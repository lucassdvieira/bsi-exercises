...
def alunos_problema(a_sorri, b_sorri):
    ...
    return a_sorri == False and b_sorri == False or a_sorri == True and b_sorri == True
...
def papagaio(falando, hora):
    ...
    return True if falando == True and (hora > 20 or hora < 7) else False
...
def final_extra(s):
    ...
    return (3 * s[-2:]) if len(s) > 1 else s
